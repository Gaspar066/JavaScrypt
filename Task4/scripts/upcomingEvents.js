...
fetch(data)
    .then(Response => (Response.json()
        .then(data =>{
          ...
          eventosFuturos(data.currentDate);
          cardsGenerator(upcomingEvents);
          categorias(eventos);
          busqueda(eventos);
        })))
...
function cardsGenerator(array) {
 ...
 // creo array para filtrar eventos futuros.

  function eventosFuturos(arr){      // Fecha a comparar
  ...
  function filtroCards(e){
    ...
    let checkboxes = upcomingEvents.filter(function (evento){
